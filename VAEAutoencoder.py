...
if __name__ == '__main__':
    ...
    autoencoder = VAEAutoencoder(encoder_layers=[2, 3, 1], learning_rate=0.1, momentum=0.0)
    print(autoencoder.initialize_weights())
    a, b = autoencoder.encode(X[0])
    Z, epsilon = autoencoder.reparametrization_trick()
